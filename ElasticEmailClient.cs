...
namespace ElasticEmailClient
{
    ...
    static class Api
    {
        ...
        public static class Account
        {
            ...
            /// <param name="accountType">Type of account: 1 for Transactional Email, 2 for Marketing Email.</param>
            ...
            public static string AddSubAccount(string email, ApiTypes.AccountType accountType, string password, string confirmPassword, bool requiresEmailCredits = false, bool enableLitmusTest = false, bool requiresLitmusCredits = false, int maxContacts = 0, bool enablePrivateIPRequest = true, bool sendActivation = false, string returnUrl = null, ApiTypes.SendingPermission? sendingPermission = null, bool? enableContactFeatures = null)
            {
                WebClient client = new CustomWebClient();
                NameValueCollection values = new NameValueCollection();
                values.Add("apikey", Api.ApiKey);
                values.Add("email", email);
                values.Add("accountType", accountType.ToString());
            ...
            public static void AddSubAccountCredits(string creditType, int credits, string notes, string subAccountEmail = null, string publicAccountID = null)
            {
                ...
                NameValueCollection values = new NameValueCollection();
                values.Add("apikey", Api.ApiKey);
                values.Add("creditType", creditType);
            ...
            public static ApiTypes.AdvancedOptions UpdateAdvancedOptions(bool? enableClickTracking = null, bool? enableLinkClickTracking = null, bool? skipListUnsubscribe = null, bool? autoTextFromHtml = null, bool? allowCustomHeaders = null, string bccEmail = "", string contentTransferEncoding = null, bool? emailNotificationForError = null, string emailNotificationEmail = "", string webNotificationUrl = "", bool? webNotificationForSent = null, bool? webNotificationForOpened = null, bool? webNotificationForClicked = null, bool? webNotificationForUnsubscribed = null, bool? webNotificationForAbuseReport = null, bool? webNotificationForError = null, string hubCallBackUrl = "", string inboundDomain = "", bool? inboundContactsOnly = null, bool? lowCreditNotification = null, bool? enableUITooltips = null, bool? enableContactFeatures = null)
            {
                ...
                if (bccEmail != "") values.Add("bccEmail", bccEmail);
                ...
                if (emailNotificationEmail != "") values.Add("emailNotificationEmail", emailNotificationEmail);
                if (webNotificationUrl != "") values.Add("webNotificationUrl", webNotificationUrl);
                ...
                if (inboundDomain != "") values.Add("inboundDomain", inboundDomain);
            ...
            /// <param name="countryID">Numeric ID of country.</param>
        ...
        public static class Campaign
        {
            ...
            /// </summary>
            /// <param name="apikey">ApiKey that gives you access to our SMTP and HTTP API's.</param>
            /// <param name="campaignNames"></param>
            ...
            public static void Export(IEnumerable<string> campaignNames, ApiTypes.ExportFileFormats fileFormat = ApiTypes.ExportFileFormats.Csv, ApiTypes.CompressionFormat compressionFormat = ApiTypes.CompressionFormat.None, string fileName = null)
            {
                ...
                NameValueCollection values = new NameValueCollection();
                values.Add("apikey", Api.ApiKey);
                values.Add("campaignNames", string.Join(",", campaignNames));
        ...
        public static class Contact
        {
            ...
            /// <param name="apikey">ApiKey that gives you access to our SMTP and HTTP API's.</param>
            /// <param name="search">Text fragment used for searching.</param>
            /// <param name="status">Name of blocked status: Abuse, Bounced or Unsubscribed</param>
            /// <param name="limit">Maximum of loaded items.</param>
            /// <param name="offset">How many items should be loaded ahead.</param>
            /// <returns>List(ApiTypes.BlockedContact)</returns>
            public static List<ApiTypes.BlockedContact> LoadBlocked(string search, ApiTypes.ContactStatus? status = null, int limit = 0, int offset = 0)
            {
                WebClient client = new CustomWebClient();
                NameValueCollection values = new NameValueCollection();
                values.Add("apikey", Api.ApiKey);
                values.Add("search", search);
                if (status != null) values.Add("status", Newtonsoft.Json.JsonConvert.SerializeObject(status));
                if (limit != 0) values.Add("limit", limit.ToString());
                if (offset != 0) values.Add("offset", offset.ToString());
            ...
            /// <param name="clearRestOfFields"></param>
            /// <returns>ApiTypes.Contact</returns>
            public static ApiTypes.Contact Update(string email, string newEmail = null, string firstName = null, string lastName = null, string organizationName = null, string title = null, string city = null, string state = null, string country = null, string zip = null, string birthDate = null, string gender = null, string phone = null, string activate = null, string industry = null, int numberOfEmployees = 0, string annualRevenue = null, int purchaseCount = 0, string firstPurchase = null, string lastPurchase = null, string notes = null, string websiteUrl = null, string mobileNumber = null, string faxNumber = null, string linkedInBio = null, int linkedInConnections = 0, string twitterBio = null, string twitterUsername = null, string twitterProfilePhoto = null, int twitterFollowerCount = 0, int pageViews = 0, int visits = 0, bool clearRestOfFields = true)
            {
                WebClient client = new CustomWebClient();
                NameValueCollection values = new NameValueCollection();
                values.Add("apikey", Api.ApiKey);
                values.Add("email", email);
                if (newEmail != null) values.Add("newEmail", newEmail);
                if (firstName != null) values.Add("firstName", firstName);
                if (lastName != null) values.Add("lastName", lastName);
                if (organizationName != null) values.Add("organizationName", organizationName);
                if (title != null) values.Add("title", title);
                ...
                if (gender != null) values.Add("gender", gender);
                if (phone != null) values.Add("phone", phone);
                if (activate != null) values.Add("activate", activate);
                if (industry != null) values.Add("industry", industry);
                if (numberOfEmployees != 0) values.Add("numberOfEmployees", numberOfEmployees.ToString());
        ...
        public static class Log
        {
            ...
            public static ApiTypes.LinkTrackingDetails LinkTracking(DateTime? from, DateTime? to, int limit = 0, int offset = 0, string channelName = null)
            {
                WebClient client = new CustomWebClient();
                NameValueCollection values = new NameValueCollection();
                values.Add("apikey", Api.ApiKey);
